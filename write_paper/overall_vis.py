...
if __name__ == '__main__':
    ...
    identifiers = ['multi-task_DeepLabv3_plus_lil_Adam_lr_0.005_use_weak_label_batch_size_4_epochs_200_ensemble_type_model-selection-mv']
    ...
    for fold_ind in [5]:
        for case_ind in [116]:
            ...
            for identifier in identifiers:
                ...
                fig, (ax1, ax2, ax3) = plt.subplots(nrows=1, ncols=3, figsize=(4.625, 3.5),
                ...
                ax2.imshow(mask, cmap)
                ax2.set_title('Ground truth', size=fontsize)

                ax3.imshow(seg, cmap)
                ax3.set_title('DGSSNet', size=fontsize)
