...
if __name__ == '__main__':
    ...
    identifiers = [
        'segmentation_DeepLabv3_plus_Adam_lr_0.005_CrossEntropyLoss_batch_size_4_epochs_600',
        'segmentation_DeepLabv3_plus_gcn_Adam_lr_0.005_CrossEntropyLoss_batch_size_4_epochs_150_beta_0.3_gcn_num_2_pre_trained',
        'MRLN_Adam_lr_0.005_epoch_600_batch_size_2_beta_40.0',
        'Vgg_swdn_Adam_lr_0.0001_epoch_300_batch_size_4',
        'multi-task_DeepLabv3_plus_lil_Adam_lr_0.005_beta_30.0_batch_size_4_epochs_600',
        ...
        'multi-task_DeepLabv3_plus_lil_Adam_lr_0.005_use_weak_label_batch_size_4_epochs_600_ensemble_type_majority-voting',
        'multi-task_DeepLabv3_plus_lil_Adam_lr_0.005_use_weak_label_batch_size_4_epochs_600_ensemble_type_model-selection',
        'multi-task_DeepLabv3_plus_lil_Adam_lr_0.005_use_weak_label_batch_size_4_epochs_600_ensemble_type_model-selection-mv']
    ...
    for identifier in identifiers:
        ...
        for fold_ind in range(1, 2):
            ...
            for case_ind in test_ind:
                ...
                seg_image = sitk.ReadImage(os.path.join(seg_dir, 'seg_' + str(case_ind) + '.nii.gz'))
