# DGMSNet
This is the official implementation of DGMSNet: Spine Segmentation for MR Image by a Detection-Guided Mixed-supervised Segmentation Network, Medical Image Analysis, Accepted, 2021.
## Requirements
- Pytorch 1.7.0
- Python 3.6.5
## Prepare dataset
