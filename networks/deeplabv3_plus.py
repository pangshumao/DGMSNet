...
class DeepLabv3_plus_2d(nn.Module):
    def __init__(self, in_channels=1, out_channels=11, os=16, num_vertebra_points=5, pretrained=False, _print=True,
                 normalization='bn', num_groups=8):
        if _print:
    ...
    def forward(self, img, return_more=False, task='localization'):
...
#     image = image.cuda()
#     model = DeepLabv3_plus_2d(nInputChannels=1, n_classes=11, os=16, pretrained=False, _print=True)
#     model = model.cuda()
#     # print(model)
